# Brouillon App finale à présenter avec : 

# taux de troncature fixe ou aléatoire 

# pour “répondre” à la troncature : ça repondère chaque erreur individuelle pour qu’au 
# final, la somme soit un estimateur non biaisé de la vraie erreur (MSE) 
# sur la population complète (non tronquée).
      ...
      card_body(
        ...
        <h4><strong>📘 Partie Théorique</strong></h4>
          ...
          <p>
            ...
            \\]
            <br>
            Ensuite, on génère la variable de troncature \\(T_i\\) suivant une distribution choisie (normale, uniforme, exponentielle, gamma), ou bien on fixe un seuil de troncature
          ...
          <p>
            ...
            <ul>
              ...
              <li>générer \\(T\\) selon la loi spécifiée ou bien on fixe un seuil de troncature </li>
